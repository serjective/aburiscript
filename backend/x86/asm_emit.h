#ifndef ABURI_BACKEND_X86_ASM_EMIT_H
#define ABURI_BACKEND_X86_ASM_EMIT_H
...
public:
    explicit AsmTextEmitter(std::ostream& out,
        ...
        : out_(out), emit_unwind_tables_(emit_unwind_tables),
          ...
          legacy32_(legacy32), code16_(code16) {}
...
private:
    ...
    std::string rip_symbol_ref(const MOperand& operand) const;
...
#endif // ABURI_BACKEND_X86_ASM_EMIT_H
