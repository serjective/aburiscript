...
constexpr auto kCounterNames = std::to_array<const char*>({
    ...
    "source.dir_cache_builds",
    "source.dir_cache_skips",
    "source.framework_lookup_attempts",
    "source.framework_lookup_hits",
    "source.framework_probes_skipped",
    "include.requests",
    ...
    "cir.types_interned",
    "cir.type_intern_hits",
    "cir.names_interned",
    "cir.name_intern_hits",
    "template.instantiation_requests",
    "template.instantiation_cache_hits",
    "template.instantiation_cache_misses",
    "template.partial_spec_selections",
    "template.max_instantiation_depth",
    "template.constraint_satisfaction_requests",
    "template.constraint_satisfaction_cache_hits",
    "template.constraint_satisfaction_cache_misses",
    "template.max_constraint_satisfaction_depth",
    "template.function_clone_instantiations",
    "template.function_clone_fallbacks",
    "template.function_token_replays",
    "template.member_clone_instantiations",
    "template.member_clone_fallbacks",
    "template.member_token_replays",
    "collect.conversion_rank_calls",
    "constexpr.eval_calls",
});
