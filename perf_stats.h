...
enum class PerfCounter {
    ...
    ParserAnnotationStoreHits,
    ParserAnnotationStoreMisses,
    ParserAnnotationOverlayHits,
    ParserAnnotationOverlayMisses,
    ParserAnnotationOverlayPublishes,
    ParserTypedAnnotationHits,
    ParserTypedAnnotationMisses,
    ParserTypedAnnotationPublishes,
    ParserTypedAnnotationConsumes,
    ParserTemplateIdAnnotationHits,
    ParserTemplateIdAnnotationMisses,
    ParserTemplateIdAnnotationPublishes,
    ParserTemplateIdFastNoMatch,
    ParserTemplateIdFastAccepts,
    ParserTemplateIdInconclusiveFallbacks,
    ParserTemplateIdSplitTokenFallbacks,
    ParserQualifiedIdAnnotationHits,
    ParserQualifiedIdAnnotationMisses,
    ParserQualifiedIdAnnotationPublishes,
    ParserQualifiedIdFastAccepts,
    ParserQualifiedIdFastRejects,
    ParserQualifiedIdInconclusiveFallbacks,
    ParserDependentQualifiedCallFastRejects,
    ParserTypeConstructionFastRejects,
    ParserTypeConstructionLookupRejects,
    ...
    ParserTemplateArgumentAnnotationHits,
    ParserTemplateArgumentAnnotationMisses,
    ParserTemplateArgumentAnnotationPublishes,
    ParserTemplateArgumentFastType,
    ParserTemplateArgumentFastExpression,
    ParserTemplateArgumentInconclusiveFallbacks,
    ParserTemplateArgumentAnnotatedTypeDirect,
    ParserTemplateArgumentAnnotatedTypeFallback,
    ParserTemplateArgumentAnnotatedTypeComplexFallback,
    ParserTemplateArgumentTentativeTypeAvoided,
    ParserDeclaratorAnnotationHits,
    ParserDeclaratorAnnotationMisses,
    ParserDeclaratorAnnotationPublishes,
    ParserDeclaratorParameterClauseFastAccepts,
    ParserDeclaratorDirectInitializerFastRejects,
    ParserDeclaratorParenSuffixTypeScopeRejects,
    ParserDeclaratorParenSuffixTypeScopeFallbacks,
    ParserQualifiedDeclaratorFastRejects,
    ParserCastDisambiguationFastAccepts,
    ParserCastDisambiguationFastRejects,
    ParserCastDisambiguationInconclusiveFallbacks,
    ParserPostfixTemplateSuffixFastRejects,
    ParserDirectTypeIdParses,
    ParserDirectTypeIdFallbacks,
    ParserDirectTypeIdComplexFallbacks,
    ParserCastDirectTypeIdParses,
    ParserCastDirectTypeIdFallbacks,
    ParserTypeConstructionDirectTypeIdParses,
    ParserTypeConstructionDirectTypeIdFallbacks,
    ParserTypeScopeAnnotationHits,
    ParserTypeScopeAnnotationMisses,
    ParserTypeScopeAnnotationPublishes,
    ParserTypeScopeFastTypeAccepts,
    ParserTypeScopeFastNonTypeRejects,
    ParserTypeScopeScopeOnlyAccepts,
    ParserTypeScopeInconclusiveFallbacks,
